...
(** Name of a service within an application (e.g. ["rpc"]). Forms a
    subdirectory of the application's discovery directory.
...
type t (** @canonical Lunarpc_discovery.Rpc_discovery.Service_name.t *)
